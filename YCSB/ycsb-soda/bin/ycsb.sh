...
bin/ycsb $1 $2 -cp $CLASSPATH \
         -P ./workloads/$3 \
         -jvm-args "-Xmx30g -Xms30g -Dsun.net.inetaddr.ttl=0 -Dtangosol.coherence.distributed.localstorage=false -Dtangosol.pof.enabled=true -Dtangosol.coherence.ttl=0 -Dtangosol.coherence.localhost=127.0.0.1 -Djava.net.preferIPv4Stack=true" \
         -s -threads $THREADS \
